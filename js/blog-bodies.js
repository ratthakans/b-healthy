/* ============================================================
   B-Healthy — bundled article bodies (offline fallback)

   Keyed by article id. Loaded only by post.html (renders one article) and
   admin.html (needs them to import into the database). The listing page
   deliberately does not load this file.

   Block types: p | h2 | ul | quote | img — see js/post.js.
   ============================================================ */

window.BLOG_BODIES = {
  "office-syndrome-signs": [
    {
      "type": "p",
    ...
    {
      "type": "h2",
      "th": "สัญญาณที่ควรจับตา",
      "en": "Signs worth watching for"
    },
    {
      "type": "ul",
      "items": [
        {
          "th": "ปวดตึงคอ บ่า ไหล่ ที่เป็นซ้ำ ๆ ในช่วงเวลาเดิมของวัน",
          "en": "Recurring neck, shoulder or upper-back tightness at the same time each day"
        },
        {
          "th": "ปวดหัวจากท้ายทอย โดยเฉพาะช่วงบ่ายแก่ ๆ",
          "en": "Headaches starting at the base of the skull, typically late afternoon"
        },
        {
          "th": "ชาหรือเสียวแปลบลงแขนและมือ",
          "en": "Numbness or tingling running down the arm or into the hand"
        },
        {
          "th": "ต้องขยับเก้าอี้หรือเปลี่ยนท่าบ่อยผิดปกติเพื่อให้นั่งได้",
          "en": "Constantly shifting position or adjusting the chair just to stay comfortable"
        },
        {
          "th": "ตาล้า แสบตา ร่วมกับอาการปวดต้นคอ",
          "en": "Eye strain showing up alongside the neck pain"
        }
      ]
    },
    {
      "type": "img",
      "src": "images/blog/office-syndrome-2.jpg",
      "alt": "พนักงานนั่งทำงานหน้าคอมพิวเตอร์ในท่าที่ล้าและเมื่อย",
      "altEn": "A tired employee slumped at a laptop",
      "caption": {
        "th": "ท่านั่งที่คอยื่นไปข้างหน้าเพิ่มภาระให้กล้ามเนื้อคอหลายเท่าตัว",
        "en": "A forward-head posture multiplies the load the neck muscles have to carry."
      }
    },
    {
      "type": "h2",
      "th": "แก้ที่ต้นเหตุ ไม่ใช่แค่ปลายทาง",
      "en": "Fix the cause, not just the symptom"
    },
    {
      "type": "p",
    ...
    {
      "type": "img",
      "src": "images/blog/office-syndrome-3.jpg",
      "alt": "พนักงานยืดเหยียดร่างกายข้างโต๊ะทำงาน",
      "altEn": "An employee stretching beside their desk",
      "caption": {
        "th": "ท่ายืดที่ดีที่สุดคือท่าที่ทำได้โดยไม่ต้องลุกจากโต๊ะ เพราะมันจะถูกทำจริง",
        "en": "The best stretch is the one you can do without leaving the desk — because it actually gets done."
      }
    }
  ],
  "sound-healing-explained": [
    ...
    {
      "type": "img",
      "src": "images/blog/sound-healing-2.jpg",
      "alt": "มือประคองขันสวดทิเบตระหว่างการทำเสียงบำบัด",
      "altEn": "Hands cradling a Tibetan singing bowl",
      "caption": {
        "th": "เสียงยาวต่อเนื่องคือจุดยึดของความสนใจ ไม่ต่างจากลมหายใจในการฝึกสมาธิ",
        "en": "A long sustained tone works as an anchor for attention, much like the breath in meditation."
      }
    },
    {
      "type": "h2",
      "th": "เหมาะกับใครในองค์กร",
      "en": "Who it suits in a workplace"
    },
    {
      "type": "ul",
      "items": [
        {
          "th": "ทีมที่เพิ่งผ่านช่วงงานหนักหรือปิดโปรเจกต์ใหญ่",
          "en": "Teams coming off a crunch or a big launch"
        },
        {
          "th": "คนที่นั่งสมาธิไม่ได้เพราะ “คิดเยอะเกินไป” — เสียงช่วยให้เกาะง่ายกว่า",
          "en": "People who can't meditate because their mind won't stop — sound gives it something easier to hold"
        },
        {
          "th": "กิจกรรมปิดท้ายวันเวิร์กชอป ที่ต้องการให้ทุกคนกลับบ้านในสภาพผ่อนคลาย",
          "en": "A closing activity, when you want everyone to leave genuinely unwound"
        }
      ]
    },
    {
    ...
    {
      "type": "img",
      "src": "images/blog/sound-healing-3.jpg",
      "alt": "ผู้เข้าร่วมใช้ขันสวดทิเบตเพื่อการผ่อนคลายในร่ม",
      "altEn": "A participant using a Tibetan singing bowl indoors",
      "caption": {
        "th": "หนึ่งรอบใช้เวลาประมาณ 45 นาที และไม่ต้องเปลี่ยนชุดหรือเตรียมอะไรมาก่อน",
        "en": "A session runs about 45 minutes, with nothing to change into and nothing to prepare."
      }
    }
  ],
  "desk-yoga-15-minutes": [
    {
      "type": "p",
    ...
    },
    {
      "type": "h2",
      "th": "ชุดท่า 15 นาที",
      "en": "The 15-minute set"
    },
    {
      "type": "ul",
      "items": [
        {
          "th": "หายใจลึก 2 นาที — นั่งหลังตรง เท้าแตะพื้น หายใจเข้า 4 จังหวะ ออก 6 จังหวะ",
          "en": "Two minutes of breathing — sit tall, feet flat, inhale for four counts, exhale for six"
        },
        {
          "th": "ยืดคอด้านข้าง 3 นาที — เอียงศีรษะค้างข้างละ 30 วินาที ไม่ดึงแรง",
          "en": "Three minutes of side-neck stretch — hold 30 seconds each side, never pull"
        },
        {
          "th": "หมุนไหล่และเปิดอก 3 นาที — ประสานมือไว้ด้านหลัง ดึงไหล่ลง",
          "en": "Three minutes of shoulder rolls and chest opening — clasp hands behind the back, draw the shoulders down"
        },
        {
          "th": "บิดตัวบนเก้าอี้ 3 นาที — หันลำตัวไปด้านข้าง จับพนักเก้าอี้ ค้างไว้",
          "en": "Three minutes of seated twists — turn to one side, hold the chair back, breathe"
        },
        {
          "th": "ยืนยืดหลังและขา 3 นาที — ก้มแตะปลายเท้าช้า ๆ แล้วค่อยยืดตัวขึ้น",
          "en": "Three minutes standing — fold forward slowly, then roll back up one vertebra at a time"
        },
        {
          "th": "นั่งนิ่ง 1 นาที — ไม่ต้องทำอะไร แค่สังเกตลมหายใจ",
          "en": "One minute sitting still — nothing to do but notice the breath"
        }
      ]
    },
    {
      "type": "img",
      "src": "images/blog/office-yoga-2.jpg",
      "alt": "ผู้ฝึกนั่งสมาธิบนเสื่อโยคะ",
      "altEn": "A person meditating on a yoga mat",
      "caption": {
        "th": "หนึ่งนาทีสุดท้ายสำคัญที่สุด — เป็นช่วงที่ระบบประสาทได้เปลี่ยนโหมดจริง ๆ",
        "en": "That last minute matters most — it's when the nervous system actually shifts gear."
      }
    },
    {
      "type": "p",
    ...
    {
      "type": "img",
      "src": "images/blog/office-yoga-3.jpg",
      "alt": "กลุ่มพนักงานยืดเหยียดร่างกายร่วมกันในคลาสกลุ่ม",
      "altEn": "A group stretching together in a class",
      "caption": {
        "th": "ทำเป็นกลุ่มช่วยให้เกิดขึ้นจริง เพราะไม่มีใครอยากเป็นคนเดียวที่ไม่ลุก",
        "en": "Doing it as a group helps it stick — nobody wants to be the only one still sitting."
      }
    }
  ],
  "food-as-medicine-lunch": [
    {
      "type": "p",
    ...
    {
      "type": "img",
      "src": "images/blog/food-as-medicine-2.jpg",
      "alt": "ผักและสมุนไพรสดในตลาด",
      "altEn": "Fresh herbs and vegetables at a market stall",
      "caption": {
        "th": "วัตถุดิบท้องถิ่นตามฤดูกาลมักสดกว่า ถูกกว่า และเข้ากับสภาพอากาศบ้านเรามากกว่า",
        "en": "Local, seasonal produce is usually fresher, cheaper, and better suited to the climate we actually live in."
      }
    },
    {
      "type": "h2",
      "th": "สามอย่างที่องค์กรทำได้เลย",
      "en": "Three things a company can change this month"
    },
    {
      "type": "ul",
      "items": [
        {
          "th": "เพิ่มตัวเลือกที่มีผักและโปรตีนในร้านค้าหรือ catering ประจำ ไม่ต้องเอาของเดิมออก",
          "en": "Add options with vegetables and protein to the regular canteen or catering list — no need to remove anything"
        },
        {
          "th": "จัดน้ำเปล่าให้เข้าถึงง่ายกว่าน้ำหวาน ตำแหน่งที่วางมีผลจริง",
          "en": "Make water easier to reach than sweetened drinks — placement genuinely changes behaviour"
        },
        {
          "th": "เลี่ยงประชุมยาวคาบเที่ยง ให้คนได้กินโดยไม่ต้องรีบ",
          "en": "Stop scheduling long meetings across lunch so people can eat without rushing"
        }
      ]
    },
    {
    ...
    {
      "type": "img",
      "src": "images/blog/food-as-medicine-3.jpg",
      "alt": "มะเขือเทศเชอร์รีและสมุนไพรสดบนโต๊ะไม้",
      "altEn": "Cherry tomatoes and herbs on a rustic table",
      "caption": {
        "th": "ในโปรแกรม Retreat เราให้แพทย์แผนไทยออกแบบเมนูตามธาตุเจ้าเรือนของแต่ละกลุ่ม",
        "en": "On our retreats, Thai traditional physicians design the menu around each group's element profile."
      }
    }
  ],
  "burnout-early-signals": [
    ...
    {
      "type": "h2",
      "th": "สัญญาณที่มักมาก่อนผลงานตก",
      "en": "Signals that arrive before performance does"
    },
    {
      "type": "ul",
      "items": [
        {
          "th": "หยุดเสนอไอเดียในที่ประชุม ทั้งที่เคยเป็นคนพูดมากที่สุด",
          "en": "Stops offering ideas in meetings, having previously been the loudest voice"
        },
        {
          "th": "ตอบอีเมลและแชตช้าลงอย่างเห็นได้ชัด",
          "en": "Noticeably slower to reply to email and chat"
        },
        {
          "th": "เริ่มลาป่วยเป็นวัน ๆ กระจาย ไม่ใช่ลายาว",
          "en": "Scattered single sick days rather than one long absence"
        },
        {
          "th": "ประชดประชันหรือพูดถึงงานด้วยน้ำเสียงเย็นชาผิดปกติ",
          "en": "Cynicism, or an unusually flat tone when talking about the work"
        },
        {
          "th": "ไม่ใช้วันลาพักร้อนที่มีอยู่",
          "en": "Leaves accrued holiday untouched"
        }
      ]
    },
    {
      "type": "img",
      "src": "images/blog/burnout-2.jpg",
      "alt": "พนักงานเหนื่อยล้าซบโต๊ะท่ามกลางเอกสารกองโต",
      "altEn": "A worn-out employee slumped over a desk covered in paperwork",
      "caption": {
        "th": "ภาระงานที่ไม่มีจุดสิ้นสุดที่ชัดเจน คือปัจจัยที่พบบ่อยที่สุด",
        "en": "Workload with no visible finish line is the most common driver."
      }
    },
    {
      "type": "h2",
      "th": "สิ่งที่ช่วยได้จริง",
      "en": "What genuinely helps"
    },
    {
      "type": "p",
    ...
    {
      "type": "img",
      "src": "images/blog/burnout-3.jpg",
      "alt": "พนักงานนั่งเหนื่อยล้าอยู่หน้าโต๊ะทำงานในออฟฟิศ",
      "altEn": "An employee sitting exhausted at an office desk",
      "caption": {
        "th": "ถามก่อนที่ผลงานจะตก คือจุดที่ต้นทุนต่ำที่สุดสำหรับทุกฝ่าย",
        "en": "Asking before output drops is the cheapest moment for everyone involved."
      }
    }
  ],
  "sleep-hidden-cost": [
    ...
    {
      "type": "h2",
      "th": "ทำไมพนักงานถึงนอนไม่หลับ ทั้งที่เหนื่อย",
      "en": "Why exhausted people still can't sleep"
    },
    {
      "type": "p",
    ...
    {
      "type": "img",
      "src": "images/blog/sleep-2.jpg",
      "alt": "ชายนอนหลับในห้องนอนที่มีแสงเช้าส่องเข้ามา",
      "altEn": "A man asleep in a sunlit bedroom",
      "caption": {
        "th": "แสงธรรมชาติตอนเช้าเป็นตัวตั้งนาฬิกาชีวภาพที่ทรงพลังที่สุด และไม่มีค่าใช้จ่าย",
        "en": "Morning daylight is the strongest — and cheapest — way to reset the body clock."
      }
    },
    {
      "type": "h2",
      "th": "สิ่งที่องค์กรควบคุมได้",
      "en": "Levers the organisation actually controls"
    },
    {
      "type": "ul",
      "items": [
        {
          "th": "วัฒนธรรมการส่งข้อความนอกเวลางาน — กำหนดให้ชัดว่าอะไรรอถึงพรุ่งนี้ได้",
          "en": "After-hours messaging culture — be explicit about what can wait until tomorrow"
        },
        {
          "th": "ตารางกะและการเดินทาง ที่ไม่บีบเวลานอนเกินไป",
          "en": "Shift patterns and travel schedules that don't squeeze sleep"
        },
        {
          "th": "แสงในออฟฟิศช่วงเช้า ยิ่งสว่างและใกล้แสงธรรมชาติยิ่งดี",
          "en": "Morning light in the office — the brighter and closer to daylight, the better"
        },
        {
          "th": "กิจกรรมผ่อนคลายช่วงเย็นในวันประชุมยาว เช่น Sound Healing หรือสมาธิสั้น ๆ",
          "en": "An evening wind-down on long meeting days — sound healing or a short meditation"
        }
      ]
    },
    {
      "type": "img",
      "src": "images/blog/sleep-3.jpg",
      "alt": "ผู้ใหญ่สวมผ้าปิดตานอนพักผ่อน",
      "altEn": "An adult resting with a sleep mask on",
      "caption": {
        "th": "งีบสั้น 15–20 นาทีช่วยฟื้นความตื่นตัว โดยไม่รบกวนการนอนกลางคืน",
        "en": "A 15–20 minute nap restores alertness without disrupting that night's sleep."
      }
    }
  ],
  "thai-elements-aroma-oil": [
    {
      "type": "p",
    ...
    {
      "type": "img",
      "src": "images/blog/elemental-aroma-2.jpg",
      ...
      "caption": {
        "th": "กลิ่นเดียวกันให้ผลต่างกันในแต่ละคน — จุดเริ่มต้นจึงควรเป็นการประเมินก่อนเลือก",
        "en": "The same scent lands differently on different people — which is why assessment should come before selection."
      }
    },
    {
      "type": "h2",
      "th": "ในเวิร์กชอปเกิดอะไรขึ้นบ้าง",
      "en": "What happens in the workshop"
    },
    {
      "type": "ul",
      "items": [
        {
          "th": "ตรวจธาตุเจ้าเรือนรายบุคคลโดยแพทย์แผนไทย",
          "en": "An individual element assessment by a Thai traditional physician"
        },
        {
          "th": "เรียนรู้กลุ่มกลิ่นที่เข้ากับธาตุของตัวเอง",
          "en": "Learning which scent families suit your own element"
        },
        {
          "th": "ผสมน้ำมันหอมระเหยสูตรเฉพาะบุคคล กลับไปใช้ต่อที่บ้านหรือที่โต๊ะทำงาน",
          "en": "Blending a personal oil to take back to your desk or home"
        }
      ]
    },
    {
    ...
    {
      "type": "img",
      "src": "images/blog/elemental-aroma-3.jpg",
      "alt": "สมุนไพรแห้งหลากชนิดบนช้อนไม้",
      "altEn": "Assorted dried herbs on wooden spoons",
      "caption": {
        "th": "สมุนไพรแต่ละชนิดถูกจัดกลุ่มตามฤทธิ์ร้อน–เย็น ซึ่งเป็นหัวใจของการปรับสมดุลธาตุ",
        "en": "Herbs are grouped by warming or cooling action — the core of how the elements are rebalanced."
      }
    }
  ],
  "measuring-wellness-roi": [
    ...
    {
      "type": "h2",
      "th": "ตัวเลขที่มีอยู่แล้วในระบบ HR",
      "en": "Numbers already sitting in your HR system"
    },
    {
      "type": "ul",
      "items": [
        {
          "th": "อัตราการลาป่วยต่อหัวต่อไตรมาส เทียบก่อน–หลังโปรแกรม",
          "en": "Sick days per head per quarter, before and after the programme"
        },
        {
          "th": "อัตราการลาออกโดยสมัครใจ แยกตามทีมที่เข้าและไม่เข้าร่วม",
          "en": "Voluntary turnover, split between teams that took part and those that didn't"
        },
        {
          "th": "การใช้สิทธิ์ประกันกลุ่มในหมวดกล้ามเนื้อและกระดูก",
          "en": "Group insurance claims in the musculoskeletal category"
        },
        {
          "th": "อัตราการเข้าร่วมกิจกรรมซ้ำ ซึ่งบอกความสมัครใจได้ดีกว่าคะแนนความพึงพอใจ",
          "en": "Repeat participation rate — a better signal of genuine buy-in than a satisfaction score"
        }
      ]
    },
    {
      "type": "img",
      "src": "images/blog/wellness-roi-2.jpg",
      "alt": "กลุ่มคนทำงานหลากหลายประชุมร่วมกันในออฟฟิศสมัยใหม่",
      "altEn": "A diverse group of professionals in a modern office meeting",
      "caption": {
        "th": "เก็บข้อมูลก่อนเริ่มโปรแกรมเสมอ — ถ้าไม่มีเส้นฐาน ก็ไม่มีอะไรให้เทียบ",
        "en": "Always capture a baseline before the programme starts — without one there's nothing to compare against."
      }
    },
    {
      "type": "h2",
      "th": "กรอบการวัดที่ใช้ได้จริง",
      "en": "A framework that survives contact with reality"
    },
    {
      "type": "p",
    ...
    {
      "type": "img",
      "src": "images/blog/wellness-roi-3.jpg",
      "alt": "ทีมงานร่วมกันทำงานในพื้นที่ออฟฟิศที่มีแสงสว่าง",
      "altEn": "A team collaborating in a bright office space",
      "caption": {
        "th": "รายงานที่สั้นและอ่านง่ายมีโอกาสถูกอ่านจริงมากกว่ารายงานสามสิบหน้า",
        "en": "A short, readable report gets read. A thirty-page one rarely does."
      }
    }
  ],
  "retreat-planning-checklist": [
    ...
    {
      "type": "h2",
      "th": "4–6 สัปดาห์ก่อนเดินทาง",
      "en": "Four to six weeks out"
    },
    {
      "type": "ul",
      "items": [
        {
          "th": "สำรวจข้อจำกัดด้านสุขภาพและอาหารของทุกคน แบบไม่ระบุตัวตน",
          "en": "Survey health and dietary constraints anonymously"
        },
        {
          "th": "ยืนยันจำนวนห้องและรูปแบบการพัก บางคนไม่สะดวกพักร่วมกับเพื่อนร่วมงาน",
          "en": "Confirm rooming — not everyone is comfortable sharing with a colleague"
        },
        {
          "th": "เช็กว่าสถานที่เข้าถึงได้สำหรับคนที่เดินไกลไม่ไหว",
          "en": "Check the venue works for anyone who can't walk far"
        },
        {
          "th": "แจ้งตารางล่วงหน้า พร้อมระบุชัดว่ากิจกรรมไหนเข้าร่วมได้ตามสมัครใจ",
          "en": "Share the schedule early, marking clearly which sessions are optional"
        }
      ]
    },
    {
      "type": "img",
      "src": "images/blog/retreat-planning-2.jpg",
      "alt": "กลุ่มคนฝึกโยคะร่วมกันริมชายหาด",
      "altEn": "A group practising yoga together on a beach",
      "caption": {
        "th": "กิจกรรมกลางแจ้งควรมีแผนสำรองในร่มเสมอ โดยเฉพาะช่วงหน้าฝน",
        "en": "Every outdoor session needs an indoor fallback — especially in the rainy season."
      }
    },
    {
      "type": "h2",
      "th": "ตารางที่เว้นที่ว่างไว้",
      "en": "Leave gaps in the schedule"
    },
    {
      "type": "p",
    ...
    {
      "type": "img",
      "src": "images/blog/retreat-planning-3.jpg",
      "alt": "มุมสูงของรีสอร์ตกลางสวนเขตร้อน",
      "altEn": "An aerial view of a resort set in a tropical garden",
      "caption": {
        "th": "เลือกสถานที่ที่เดินทางไม่เกินสามชั่วโมง เพื่อไม่ให้เสียวันแรกไปกับการเดินทาง",
        "en": "Pick somewhere under three hours away, so day one isn't spent in transit."
      }
    }
  ],
  "flower-mandala-art-therapy": [
    {
      "type": "p",
    ...
    {
      "type": "img",
      "src": "images/blog/flower-mandala-2.jpg",
      "alt": "แมนดาลาทำมือล้อมรอบด้วยดอกไม้แห้ง",
      "altEn": "A handmade mandala surrounded by dried flowers",
      "caption": {
        "th": "ไม่มีแบบที่ถูกต้อง ทำให้ไม่มีใครรู้สึกว่าตัวเองทำผิด",
        "en": "There's no correct version, so nobody can feel they got it wrong."
      }
    },
    {
      "type": "h2",
      "th": "ทำไมถึงเหมาะกับกิจกรรมทีม",
      "en": "Why it works as a team activity"
    },
    {
      "type": "ul",
      "items": [
        {
          "th": "ไม่มีการแข่งขัน จึงไม่มีใครถูกเปรียบเทียบ",
          "en": "No competition, so nobody gets compared"
        },
        {
          "th": "ทำร่วมกันเป็นวงใหญ่ได้ ทำให้เกิดบทสนทนาโดยไม่ต้องบังคับ",
          "en": "It can be built as one large circle, which starts conversation without forcing it"
        },
        {
          "th": "ใช้เวลา 45–60 นาที พอดีกับช่วงบ่ายที่คนล้า",
          "en": "Runs 45–60 minutes — a good fit for the flat part of the afternoon"
        },
        {
          "th": "วัสดุย่อยสลายได้ ไม่เหลือขยะหลังกิจกรรม",
          "en": "The materials compost — nothing left behind"
        }
      ]
    },
    {
      "type": "img",
      "src": "images/blog/flower-mandala-3.jpg",
      "alt": "การจัดกลีบดอกไม้เป็นลวดลายวงกลมบนพื้นไม้",
      "altEn": "Flower petals laid out in a circular pattern on a wooden deck",
      "caption": {
        "th": "ความไม่ถาวรของผลงานเป็นส่วนหนึ่งของกิจกรรม — ทำเสร็จแล้วปล่อยไป",
        "en": "The impermanence is part of it — you finish, then you let it go."
      }
    }
  ]
};
